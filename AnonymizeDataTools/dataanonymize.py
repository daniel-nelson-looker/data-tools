...
from customanonymize import company_name
from customanonymize import fake
from customanonymize import DataFetcher
from customanonymize import DataAnonymizer
...
def main():
    ...
    ## Pull in the gs file
    conf.extract_gs_to_local(output_file=original_data)
    ...
    anon = DataAnonymizer(input_filepath=original_data)
